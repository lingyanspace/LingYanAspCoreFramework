...
namespace LingYan.DynamicShardingDBT.DBTProvider
{
    ...
    public interface IDynamicShardingQueryable<T> where T : class 
    {
        /// <summary>
        /// 筛选
        /// </summary>
        ...
        /// <returns></returns>
        IDynamicShardingQueryable<T> Where(Expression<Func<T, bool>> predicate);
        ...
        /// <returns></returns>
        IDynamicShardingQueryable<T> Where(string predicate, params object[] values);
        ...
        /// <returns></returns>
        IDynamicShardingQueryable<T> Skip(int count);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        IDynamicShardingQueryable<T> Take(int count);
        ...
        /// <returns></returns>
        IDynamicShardingQueryable<T> OrderBy<TKey>(Expression<Func<T, TKey>> keySelector);
        ...
        /// <param name="keySelector">表达式</param>
        /// <returns></returns>
        IDynamicShardingQueryable<T> OrderByDescending<TKey>(Expression<Func<T, TKey>> keySelector);
        ...
        /// <param name="values">参数</param>
        /// <returns></returns>
        IDynamicShardingQueryable<T> OrderBy(string ordering, params object[] values);
