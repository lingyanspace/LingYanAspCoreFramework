...
{
    internal abstract class DefaultDbService : DefaultBaseDbService, IDynamicDBTService
    {
        ...
        public int UpdateSql<T>(Expression<Func<T, bool>> where, params (string field, DynamicUpdateType updateType, object value)[] values) where T : class
        {
            return AsyncHelper.RunSync(() => UpdateSqlAsync(where, values));
        }
        public int UpdateSql(IQueryable source, params (string field, DynamicUpdateType updateType, object value)[] values)
        {
            return AsyncHelper.RunSync(() => UpdateSqlAsync(source, values));
        }
        public Task<int> UpdateSqlAsync<T>(Expression<Func<T, bool>> where, params (string field, DynamicUpdateType updateType, object value)[] values) where T : class
        {
        ...
        public abstract DynamicDBType DbType { get; }
        public abstract IDynamicDBTService FullDbAccessor { get; }
        ...
        public abstract Task<int> UpdateSqlAsync(IQueryable source, params (string field, DynamicUpdateType updateType, object value)[] values);
