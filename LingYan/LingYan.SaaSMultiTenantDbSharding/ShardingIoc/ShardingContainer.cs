...
{
    internal class ShardingContainer
    {
        #region 构造函数
        ...
        private readonly SynchronizedCollection<DataSource> _dataSources = new SynchronizedCollection<DataSource>();
        private readonly SynchronizedCollection<ShardingRule> _shardingRules = new SynchronizedCollection<ShardingRule>();
        private readonly SynchronizedCollection<PhysicTable> _physicTables = new SynchronizedCollection<PhysicTable>();
