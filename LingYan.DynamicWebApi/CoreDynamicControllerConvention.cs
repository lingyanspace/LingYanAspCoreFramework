    ...
    public class CoreDynamicControllerConvention : IApplicationModelConvention
    {
        ...
        public void Apply(ApplicationModel application)
        {
            ...
            foreach (var controller in application.Controllers)
            {
                ...
                if ((typeof(LYCoreDynamicRouteAbility).IsAssignableFrom(controllerType)||controllerType.IsDefined(typeof(LYCoreDynamicRouteAbilityAttribute), true)))
                {
        ...
        private AttributeRouteModel CreateActionRoutePath(string controllerName, string actionName)
        {
            ...
            if (!_configuration.GetSection("DynamicHttpRoutePrefix").Get<string>().IsNullOrEmpty())
            {
